...
reference = "fr-041_debris.mp4" # Ensure this file exists in the same directory or provide its full path
encoded_videos = [
    "fr-041_debris_av1_360p_crf18.mkv", "fr-041_debris_av1_360p_crf24.mkv",
    "fr-041_debris_av1_360p_crf30.mkv", "fr-041_debris_av1_360p_crf36.mkv",
    "fr-041_debris_av1_720p_crf18.mkv", "fr-041_debris_av1_720p_crf24.mkv",
    "fr-041_debris_av1_720p_crf30.mkv", "fr-041_debris_av1_720p_crf36.mkv",
    "fr-041_debris_av1_1080p_crf18.mkv", "fr-041_debris_av1_1080p_crf24.mkv",
    "fr-041_debris_av1_1080p_crf30.mkv", "fr-041_debris_av1_1080p_crf36.mkv",
    "fr-041_debris_av1_2160p_crf18.mkv", "fr-041_debris_av1_2160p_crf24.mkv",
    "fr-041_debris_av1_2160p_crf30.mkv", "fr-041_debris_av1_2160p_crf36.mkv"
]

os.makedirs("vmaf_json_debris_av1", exist_ok=True)

vmaf_results = []

for encoded in encoded_videos:
    # --- CORRECTED INDICES FOR RESOLUTION AND CRF EXTRACTION FOR "fr-041_debris" FILENAMES ---
    # Example split('_') for "fr-041_debris_av1_360p_crf18.mkv":
    # ['fr-041', 'debris', 'av1', '360p', 'crf18.mkv']
    ...
    json_path = f"vmaf_json_debris_av1/{encoded.replace('.mkv', '')}.json"
...
df.to_csv("vmaf_results_debris_av1.csv", index=False)
...
plt.savefig("vmaf_vs_crf_av1_debris.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("bitrate_vs_vmaf_av1_debris.png")
plt.show()