...
reference = "bigbuck_bunny.mkv"
encoded_videos = [
    "bigbuck_bunny_av1_360p_crf18.mkv", "bigbuck_bunny_av1_360p_crf24.mkv",
    "bigbuck_bunny_av1_360p_crf30.mkv", "bigbuck_bunny_av1_360p_crf36.mkv",
    "bigbuck_bunny_av1_720p_crf18.mkv", "bigbuck_bunny_av1_720p_crf24.mkv",
    "bigbuck_bunny_av1_720p_crf30.mkv", "bigbuck_bunny_av1_720p_crf36.mkv",
    "bigbuck_bunny_av1_1080p_crf18.mkv", "bigbuck_bunny_av1_1080p_crf24.mkv",
    "bigbuck_bunny_av1_1080p_crf30.mkv", "bigbuck_bunny_av1_1080p_crf36.mkv",
    "bigbuck_bunny_av1_2160p_crf18.mkv", "bigbuck_bunny_av1_2160p_crf24.mkv",
    "bigbuck_bunny_av1_2160p_crf30.mkv", "bigbuck_bunny_av1_2160p_crf36.mkv"
]

os.makedirs("vmaf_json_bigbuck_bunny_av1", exist_ok=True)

vmaf_results = []

for encoded in encoded_videos:
    res = encoded.split('_')[3].replace('p', '')
    crf_str = encoded.split('_')[4].replace('.mkv', '')
    crf = int(crf_str.replace('crf', ''))
    json_path = f"vmaf_json_bigbuck_bunny_av1/{encoded.replace('.mkv', '')}.json"
...
df.to_csv("vmaf_results_bigbuck_bunny_av1.csv", index=False)
...
plt.savefig("vmaf_vs_crf_av1_bigbuck_bunny.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("bitrate_vs_vmaf_av1_bigbuck_bunny.png")
plt.show()
