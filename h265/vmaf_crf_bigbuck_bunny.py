...
encoded_videos = [
    "bigbuck_bunny_h265_360p_crf18.mp4", "bigbuck_bunny_h265_360p_crf24.mp4",
    "bigbuck_bunny_h265_360p_crf30.mp4", "bigbuck_bunny_h265_360p_crf36.mp4",
    "bigbuck_bunny_h265_720p_crf18.mp4", "bigbuck_bunny_h265_720p_crf24.mp4",
    "bigbuck_bunny_h265_720p_crf30.mp4", "bigbuck_bunny_h265_720p_crf36.mp4",
    "bigbuck_bunny_h265_1080p_crf18.mp4", "bigbuck_bunny_h265_1080p_crf24.mp4",
    "bigbuck_bunny_h265_1080p_crf30.mp4", "bigbuck_bunny_h265_1080p_crf36.mp4",
    "bigbuck_bunny_h265_2160p_crf18.mp4", "bigbuck_bunny_h265_2160p_crf24.mp4",
    "bigbuck_bunny_h265_2160p_crf30.mp4", "bigbuck_bunny_h265_2160p_crf36.mp4"
]

os.makedirs("vmaf_json_bigbuck_bunny", exist_ok=True)
...
for encoded in encoded_videos:
    ...
    json_path = f"vmaf_json_bigbuck_bunny/{encoded.replace('.mp4', '')}.json"
...
df.to_csv("vmaf_results_bigbuck_bunny.csv", index=False)
...
plt.savefig("vmaf_vs_crf_scatter_with_scores_bigbuck_bunny.png")
plt.show()