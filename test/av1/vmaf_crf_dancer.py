...
encoded_videos = [
    "Dancers_8s_av1_360p_crf18.mkv", "Dancers_8s_av1_360p_crf24.mkv",
    "Dancers_8s_av1_360p_crf30.mkv", "Dancers_8s_av1_360p_crf36.mkv",
    "Dancers_8s_av1_720p_crf18.mkv", "Dancers_8s_av1_720p_crf24.mkv",
    "Dancers_8s_av1_720p_crf30.mkv", "Dancers_8s_av1_720p_crf36.mkv",
    "Dancers_8s_av1_1080p_crf18.mkv", "Dancers_8s_av1_1080p_crf24.mkv",
    "Dancers_8s_av1_1080p_crf30.mkv", "Dancers_8s_av1_1080p_crf36.mkv",
    "Dancers_8s_av1_2160p_crf18.mkv", "Dancers_8s_av1_2160p_crf24.mkv",
    "Dancers_8s_av1_2160p_crf30.mkv", "Dancers_8s_av1_2160p_crf36.mkv"
]

os.makedirs("vmaf_json_dancers_av1", exist_ok=True)
...
for encoded in encoded_videos:
    ...
    json_path = f"vmaf_json_dancers_av1/{encoded.replace('.mkv', '')}.json"
...
df.to_csv("vmaf_results_dancers_av1.csv", index=False)
...
plt.savefig("vmaf_vs_crf_av1_dancers.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("bitrate_vs_vmaf_av1_dancers.png")
plt.show()