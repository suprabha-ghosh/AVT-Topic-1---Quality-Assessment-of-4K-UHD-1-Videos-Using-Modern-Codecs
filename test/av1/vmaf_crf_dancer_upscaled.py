...
reference = "Dancers_8s.mp4"
encoded_videos = [
    "Dancers_8s_av1_360p_crf18_upscaled_4k.mp4", "Dancers_8s_av1_360p_crf24_upscaled_4k.mp4",
    "Dancers_8s_av1_360p_crf30_upscaled_4k.mp4", "Dancers_8s_av1_360p_crf36_upscaled_4k.mp4",
    "Dancers_8s_av1_720p_crf18_upscaled_4k.mp4", "Dancers_8s_av1_720p_crf24_upscaled_4k.mp4",
    "Dancers_8s_av1_720p_crf30_upscaled_4k.mp4", "Dancers_8s_av1_720p_crf36_upscaled_4k.mp4",
    "Dancers_8s_av1_1080p_crf18_upscaled_4k.mp4", "Dancers_8s_av1_1080p_crf24_upscaled_4k.mp4",
    "Dancers_8s_av1_1080p_crf30_upscaled_4k.mp4", "Dancers_8s_av1_1080p_crf36_upscaled_4k.mp4",
    "Dancers_8s_av1_2160p_crf18_upscaled_4k.mp4", "Dancers_8s_av1_2160p_crf24_upscaled_4k.mp4",
    "Dancers_8s_av1_2160p_crf30_upscaled_4k.mp4", "Dancers_8s_av1_2160p_crf36_upscaled_4k.mp4"
]

os.makedirs("vmaf_json_dancers_av1_upscaled", exist_ok=True)

vmaf_results = []

for encoded in encoded_videos:
    # --- CORRECTED INDICES FOR RESOLUTION AND CRF EXTRACTION FOR DANCERS_8s FILENAMES ---
    # Based on filename structure: Dancers_8s_av1_360p_crf18.mkv
    # split('_') gives: ['Dancers', '8s', 'av1', '360p', 'crf18.mkv']
    res = encoded.split('_')[3].replace('p', '')  # '360p' is at index 3
    crf_str = encoded.split('_')[4].replace('.mkv', '') # 'crf18.mkv' is at index 4
    crf = int(crf_str.replace('crf', ''))
    json_path = f"vmaf_json_dancers_av1_upscaled/{encoded.replace('.mkv', '')}.json"
    ...
    cmd = [
        ...
        "-i", encoded,
        "-lavfi",
        f"[0:v]scale=3840x2160:flags=bicubic[ref];"
        f"[1:v]scale=3840x2160:flags=bicubic[dist];"
...
df.to_csv("vmaf_results_dancers_av1_upscaled.csv", index=False)
...
plt.savefig("vmaf_vs_crf_av1_dancers_upscaled.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("bitrate_vs_vmaf_av1_dancers_upscaled.png")
plt.show()